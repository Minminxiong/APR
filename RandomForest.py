# -*- coding: utf-8 -*-
"""
Created on Tue Jan  1 15:37:49 2019
...
def main(args):
    print("随机森林方法：")
    RandomForest = Log_reg(RandomForestClassifier())
    RandomForest.fit_logistic_regression(args.input_trainFile)
    RandomForest.predict_test(args.input_testFile)
    
    print("AdaBoost分类器方法：")
    RandomForest = Log_reg(AdaBoostClassifier())
    RandomForest.fit_logistic_regression(args.input_trainFile)
    RandomForest.predict_test(args.input_testFile)
